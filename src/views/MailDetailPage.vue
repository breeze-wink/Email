    ...
    <ion-header>
      <ion-toolbar color="dark">
        <ion-buttons slot="start">
          <ion-back-button :icon="arrowBackCircleOutline" default-href="/MailTabs/mailTab" text="返回"></ion-back-button>
        </ion-buttons>
...
import { IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonList, IonListHeader, IonItem, IonLabel, IonIcon, IonButton, IonSpinner, IonBackButton, IonButtons, IonFooter } from '@ionic/vue';
