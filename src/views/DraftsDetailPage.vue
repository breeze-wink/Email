      ...
      <ion-header>
        <ion-toolbar color="dark">
          <ion-buttons slot="start">
            <ion-back-button :icon="arrowBackCircleOutline" default-href="/MailTabs/drafts" text="返回"></ion-back-button>
          </ion-buttons>
...
import { arrowBackCircleOutline, documentOutline, downloadOutline } from 'ionicons/icons';
  ...
  const fetchMailDetails = async () => {
    try {
      ...
      const response = await apiClient.get<Mail>(`/api/drafts/${mailId}`);
